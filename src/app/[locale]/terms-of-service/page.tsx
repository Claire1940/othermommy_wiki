...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Other Mommy Wiki",
    description: "Read the Terms of Service for Other Mommy Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our film resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Other Mommy Wiki",
      description: "Terms and conditions for using Other Mommy Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Other Mommy Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Other Mommy Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Other Mommy Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Other Mommy Wiki is an unofficial, community-driven fan website that provides information, guides, and
              resources related to the 2026 supernatural horror film Other Mommy. Our services include, but are not
              limited to:
            </p>
            <ul>
              <li>Cast and character profiles</li>
              <li>Plot and story analysis</li>
              <li>Trailer and official video coverage</li>
              <li>Release date and ticket information</li>
              <li>Source novel (Incidents Around the House) coverage</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Other Mommy Wiki is NOT affiliated with, endorsed by, or associated with
              Universal Pictures, Blumhouse Productions, Atomic Monster, or the filmmakers of Other Mommy. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Other Mommy Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Film Content</h3>
            <p>
              All film-related content, including but not limited to character images, film stills, logos, and
              trademarks, are the property of Universal Pictures, Blumhouse Productions, and Atomic Monster and/or the filmmakers of Other Mommy. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. New release information may render some details outdated.</li>
              ...
              <li><strong>Release & Ticketing:</strong> Release dates, theater listings, and ticket availability may change without notice. We are not responsible for changes made by distributors or exhibitors.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, OTHER MOMMY WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including YouTube, IMDb, social media platforms,
            ...
            <p>
              ...
              you and Other Mommy Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@othermommy.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@othermommy.wiki</a>
            </p>
            <p>
